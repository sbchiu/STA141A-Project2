...
The plot below is of new deaths versus new cases. Here, we can observe that although when new cases start to rise, the number of new deaths stays the same. Rarely does it happen when there are lower new cases, but a spike in new deaths in those cases.
