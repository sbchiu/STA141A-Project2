...
The plot below is of new deaths versus new cases. Here, we can observe that although when new cases start to rise, the number of new deaths mostly stays the same. Rarely does it happen when there are lower new cases and a spike in deaths in those cases.

```{r, echo = FALSE}
fig3 <- newdata %>% 
  filter(Date>= "2020-03-01", Date<= "2020-11-30", WHO_region=="AMRO") %>% 
